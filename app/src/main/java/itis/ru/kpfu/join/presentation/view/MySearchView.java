...
public class MySearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private com.miguelcatalan.materialsearchview.MaterialSearchView.OnQueryTextListener mOnQueryChangeListener;

    private com.miguelcatalan.materialsearchview.MaterialSearchView.SearchViewListener mSearchViewListener;
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = mContext
                .obtainStyledAttributes(attrs, com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView,
                        defStyleAttr, 0);
        ...
        if (a != null) {
            if (a.hasValue(com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchBackground)) {
                setBackground(a.getDrawable(
                        com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchBackground));
            }
            ...
            if (a.hasValue(com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_android_textColor)) {
                setTextColor(a.getColor(
                        com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_android_textColor, 0));
            }

            if (a.hasValue(
                    com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_android_textColorHint)) {
                setHintTextColor(a.getColor(
                        com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_android_textColorHint,
                        0));
            }
            ...
            if (a.hasValue(com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_android_hint)) {
                setHint(a
                        .getString(com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_android_hint));
            }

            if (a.hasValue(com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchVoiceIcon)) {
                setVoiceIcon(a.getDrawable(
                        com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchVoiceIcon));
            }

            if (a.hasValue(com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchCloseIcon)) {
                setCloseIcon(a.getDrawable(
                        com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchCloseIcon));
            }

            if (a.hasValue(com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchBackIcon)) {
                setBackIcon(a.getDrawable(
                        com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchBackIcon));
            }

            if (a.hasValue(
                    com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchSuggestionBackground)) {
                setSuggestionBackground(a.getDrawable(
                        com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchSuggestionBackground));
            }

            if (a.hasValue(
                    com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchSuggestionIcon)) {
                setSuggestionIcon(a.getDrawable(
                        com.miguelcatalan.materialsearchview.R.styleable.MaterialSearchView_searchSuggestionIcon));
            }
    ...
    private void initiateView() {
        ...
        mSearchTopBar = (RelativeLayout) mSearchLayout
                .findViewById(com.miguelcatalan.materialsearchview.R.id.search_top_bar);
        mSuggestionsListView = (ListView) mSearchLayout
                .findViewById(com.miguelcatalan.materialsearchview.R.id.suggestion_list);
        mSearchSrcTextView = (EditText) mSearchLayout
                .findViewById(com.miguelcatalan.materialsearchview.R.id.searchTextView);

        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) mSearchSrcTextView.getLayoutParams();
        layoutParams.width = DimensionKt.toPx(330, getContext());
        mSearchSrcTextView.setLayoutParams(layoutParams);
    ...
    public void setOnQueryTextListener(
            com.miguelcatalan.materialsearchview.MaterialSearchView.OnQueryTextListener listener) {
    ...
    public void setOnSearchViewListener(
            com.miguelcatalan.materialsearchview.MaterialSearchView.SearchViewListener listener) {
